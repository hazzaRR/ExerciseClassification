...
print("********** accel + gyro **********")
print(tsf_experiment_mulitvariate(X_train, y_train, X_test, y_test, 5))


print("********** accel **********")
print(tsf_experiment_mulitvariate(X_train_acc, y_train, X_test_acc, y_test, 5))


print("********** gyro **********")
print(tsf_experiment_mulitvariate(X_train_gyro, y_train, X_test_gyro, y_test, 5))


print("********** accel X **********")
print(tsf_experiment_univariate(X_train.iloc[:,0:1], y_train, X_test.iloc[:,0:1], y_test, 5))


print("********** accel Y **********")
print(tsf_experiment_univariate(X_train.iloc[:,1:2], y_train, X_test.iloc[:,1:2], y_test, 5))


print("********** accel Z **********")
print(tsf_experiment_univariate(X_train.iloc[:,2:3], y_train, X_test.iloc[:,2:3], y_test, 5))


print("********** gyro X **********")
print(tsf_experiment_univariate(X_train.iloc[:,3:4], y_train, X_test.iloc[:,3:4], y_test, 5))


print("********** gyro Y **********")
print(tsf_experiment_univariate(X_train.iloc[:,4:5], y_train, X_test.iloc[:,4:5], y_test, 5))

print("********** gyro Z **********")
print(tsf_experiment_univariate(X_train.iloc[:,5:6], y_train, X_test.iloc[:,5:6], y_test, 5))
